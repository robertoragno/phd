...
In addition to base R, several packages enhance its performances and offer more tools to users. The packages are distributed by the official [CRAN repository](https://cran.r-project.org/web/packages/), which counts more than 19,909 packages[^methods-2]. This section details some of the packages that have been most useful for this research.

[^methods-2]: Updated on September 21st, 2023.
