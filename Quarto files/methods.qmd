...
-   need to add the conventions for Zooarch
:::
...
-   Selecting samples where the total of seeds was greater than 10. The total includes fruits, nuts and legumes in such a way that samples poor in grains but rich in other seeds were not of minor importance in the calculations, and were in essence considered reliable. This process resulted in a more limited number of samples available for analysis. The sample sizes after pre-processing can be viewed in @sec-richness-macroregions. Although the lower limit of the allowable sample size may appear small (which may affect species richness), some sites reported low numbers of seeds.
...
: Output of `precis(m2)`. Some rows have been excluded for ease of reading. {#tbl-precis-example-methods tbl-colwidths="\[10, 1, 5, 5, 5, 5, 5, 5, 5, 1, 1\]"}
