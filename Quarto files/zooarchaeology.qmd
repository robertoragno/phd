...
We aim to investigate whether there are differences in the relative amount of NISP data among southern, central, and northern Italy during various chronological periods. Building upon the methods utilised in @sec-bot-res-macroregion, we construct a DAG that highlights the necessity of blocking by `Chronology` and stratifying by `Macroregion`, in a similar manner to the previous analysis.
