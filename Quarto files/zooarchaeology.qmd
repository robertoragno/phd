...
Animals_by_Century_a.plot <- Animals_by_Century_a_fit %>%
  ...
  labs(
    ...
    title = "Animals",
    subtitle = "Century",
    caption = "The dashed line indicates the diachronical average of occurrence for each animal."
  ) +
  theme_tidybayes() +
  theme(
...
Animals_by_Century_phi.plot <- Animals_by_Century_phi_fit %>%
  ...
  labs(
    ...
    title = "Animals",
    subtitle = "Century",
    caption = "The dashed line indicates the average precision for each animal dataset."
  ) +
  theme_tidybayes() +
  theme(
    legend.position = "bottom",
